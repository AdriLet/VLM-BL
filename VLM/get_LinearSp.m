function [X_V,Y_V,Z_V] = get_LinearSp (X,Y,Z,M,N)
...
%4 Linear spacing in s,t coordinates

for j=1:N
    
    s_V_LinearSp (:,j) = linspace(0,1,M);
                 
end

for i=1:M

    t_V_LinearSp (i,:) = linspace(0,1,N);
...
%5 Interpolation in s and t coordinates
 ...
 X_V_0rot = griddata(s,t,X0,s_V_LinearSp,t_V_LinearSp,'linear');
 Y_V_0rot = griddata(s,t,Y0_rot,s_V_LinearSp,t_V_LinearSp,'linear');
 Z_V_0rot = griddata(s,t,Z0_rot,s_V_LinearSp,t_V_LinearSp,'linear');
